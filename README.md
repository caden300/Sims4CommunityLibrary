...
-  the latest zip archive from the [](https://github.com/ColonolNutty/Sims4CommunityLibrary/) page (It is the one with the version number in it Example: sims4communitylib.v0.0.0.zip) (Ignore the ones that say Source Code)
...
- Use the green button in the top right [The Main Page](https://github.com/ColonolNutty/Sims4CommunityLibrary) to  this project as a zip file.
